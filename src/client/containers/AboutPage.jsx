      ...
      <section id="features">
        <main className="div-main">
          ...
          <div className="feature-btns">
            <button className="feature-btn">Download for Mac Silicon</button>
            <button className="feature-btn">Download for Mac Intel</button>
          </div>
        </main>
        <figure className="feature-right-side">
          ...
          <div className="feature-square">
            ...
            <p className="features-right-heading">
              In Depth Analysis for OOMKilled Pods
            </p>
            <p className="features-text">
        ...
        <div className="spectacular">
          <div className="spectacular-person">
            <div className="spectacular-person-photo">
              {' '}
              <img src="public/Si-Young-Mah.png" alt="" />
              {/* <img src="public/logo.png" alt="" /> */}
            </div>
          ...
          <div className="spectacular-person">
            <div className="spectacular-person-photo">
              {' '}
              <img src="public/Patrick-Hu.png" alt="" />
              {/* <img src="public/logo.png" alt="" /> */}
            </div>
          ...
          <div className="spectacular-person">
            <div className="spectacular-person-photo">
              {' '}
              <img src="public/Thang-Thai.png" alt="" />
              {/* <img src="public/logo.png" alt="" /> */}
            </div>
          ...
          <div className="spectacular-person">
            <div className="spectacular-person-photo">
              {' '}
              <img src="public/Raivyno-Sutrisno.jpg" alt="" />
            </div>
